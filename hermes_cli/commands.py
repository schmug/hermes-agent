...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("thumbsup", "Rate the last turn positively (feedback signal)",
               "Tools & Skills", cli_only=True, aliases=("tu",)),
    CommandDef("thumbsdown", "Rate the last turn negatively (feedback signal)",
               "Tools & Skills", cli_only=True, aliases=("td",)),
    CommandDef("unrate", "Clear the rating on the last turn",
               "Tools & Skills", cli_only=True),
    CommandDef("feedback", "Show feedback stats or run the optimization loop",
               "Tools & Skills", cli_only=True, args_hint="[stats|optimize]",
               subcommands=("stats", "optimize")),
